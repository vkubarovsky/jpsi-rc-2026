...
We suggest recording this immediately after the closed-form expressions proposed
in Section~5 below, since those expressions are precisely Eq.~(26) of [10] with
the term restored --- the provenance and the correction then appear together.
The sentence claiming agreement would become a pointer to that paragraph.
Suggested wording for it:
